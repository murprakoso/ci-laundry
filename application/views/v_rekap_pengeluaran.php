...
<div class="right_col" role="main" style="min-height: 100vh!important;">
    <div class="">
        ...
        <div class="row">
            <div class="col-md-6">
                <h3 class="m-0" id="titleprint">Rekap Pengeluaran Kas</h3>
            </div>
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-lg-5 col-md-12 col-xs-12 pl-4">
                                <!-- Form -->
                                <form action="<?= base_url('rekap-pengeluaran'); ?>" method="post">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable" class="table table-hover table-bordered" style="width:100%">
                                        <form action="<?= base_url('rekap_pengeluaran/hapus_rekap'); ?>" method="POST" id="form-delete"></form>
                                        <thead>
                                            <tr>
                                                <th class="tidakprint">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            foreach ($rekappengeluaran->result() as $row) : ?>
                                                <tr>
                                                    ...
                                                    <!-- <td class="text__16 tidakprint">
                                                        ...
                                                        <a href="<?= base_url('rekap_pengeluaran/hapus/' . $row->rekap_id); ?>" title="Delete" class="tombol-konfirmasi"><span class="fa fa-trash"></span></a>
                                                    </td> -->
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
